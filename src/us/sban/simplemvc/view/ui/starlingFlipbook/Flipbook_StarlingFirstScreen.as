package us.sban.simplemvc.view.ui.starlingFlipbook
{
	...
	public class Flipbook_StarlingFirstScreen extends Sprite
	{
		[Embed(source="flash-pf.xml", mimeType="application/octet-stream")]
		public static const bookXml:Class;
		[Embed(source="flash-pf.png")]
		...
		public function Flipbook_StarlingFirstScreen()
		{
			super();
