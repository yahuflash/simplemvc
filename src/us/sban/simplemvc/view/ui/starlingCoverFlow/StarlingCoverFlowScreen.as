package us.sban.simplemvc.view.ui.starlingCoverFlow
{
	...
	public class StarlingCoverFlowScreen extends Sprite
	{
		[Embed(source="ad.xml", mimeType="application/octet-stream")]
		...
		public function StarlingCoverFlowScreen()
		{
			super();
			initGame();
		}
