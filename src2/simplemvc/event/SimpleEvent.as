package simplemvc.event
{
	...
	public final class SimpleEvent implements IReusable{
		...
		public function toFlashSimpleEvent():FlashSimpleEvent{
			return new FlashSimpleEvent(type,args);
		}
		...
		public function dispatchInGlobal():void{
			SimpleEventDispatcher.sharedSimpleDispatcher().dispatchEvent(this);
			release();
		}
