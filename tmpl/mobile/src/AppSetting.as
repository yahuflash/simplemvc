package
{
    import simplemvc.view.StarlingScreenNavigator;
    
    import starling.errors.AbstractClassError;

    public class AppSetting
    {
        public function AppSetting() { throw new AbstractClassError(); }
		...
		public static const StartUpClass:Class = StarlingScreenNavigator;
		public static var DefaultScreenClass:Class = DefaultScreenTest;
    }
}